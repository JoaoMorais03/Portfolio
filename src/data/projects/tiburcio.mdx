...
type: "personal"
status: "live"
technologies: ["TypeScript", "Node.js", "Vue 3", "MCP", "RAG", "Claude AI", "Mastra AI", "Qdrant", "PostgreSQL", "Drizzle ORM", "Redis", "BullMQ", "Docker", "Vitest"]
featured: true
...
It ships in two forms: a web chat UI built with Vue 3, and an MCP server so Claude Code can query the same knowledge base while you're coding.
